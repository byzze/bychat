    ...
    <div class="mobile-page">
        ...
        <script type="text/javascript">
            ...
            ws.onopen = function (evt) {
                ...
                console.log("用户准备登陆:" + person);
                ws.send('{"seq":"' + sendID() + '","cmd":"login","data":{"userID":"' + person + '","appID":'+ 0 +'}}');
            ...
            function getHistoryMessageList() {
                $.ajax({
                    ...
                    success: function (res) {
                        //console.log("message list:" + res.code + " messageList:" + res.data);
                        if (res.code != 0) {
                            return false
                        }
                        ...
                        $.each(res.data.data, function (i, n) {
                            ...
                            console.log("message list----:", data_array.cmd)
                            if (data_array.cmd != "msg") {
                                return true
                            }
                            if (data.data.from === person ) {
                                data = data_array.response.data
                                addChatWith(myMsg(data.data.from, data.data.msg))
                            }else{
                                addChatWith(msg(data.data.from, data.data.msg))
                            }
                        });
                        return false
                    }
            ...
            function EnterChatRoom() {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        addChatWith(myMsg(person, "我进入了"+roomID+"房间"))
                        $("input[name='msg']").val("");
                    }
                });
            }
